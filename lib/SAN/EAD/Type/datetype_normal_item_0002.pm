...
package SAN::EAD::Type::datetype_normal_item_0002;


our @ISA=qw(XML::Pastor::Builtin::string);

SAN::EAD::Type::datetype_normal_item_0002->XmlSchemaType( bless( {
...
B<SAN::EAD::Type::datetype_normal_item_0002>  -  A class generated by L<XML::Pastor> . 
