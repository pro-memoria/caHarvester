...
package SAN::EAC::ns003::Type::lang_item_0001;


our @ISA=qw(XML::Pastor::Builtin::string);

SAN::EAC::ns003::Type::lang_item_0001->XmlSchemaType( bless( {
...
B<SAN::EAC::ns003::Type::lang_item_0001>  -  A class generated by L<XML::Pastor> . 
