...
package SAN::EAC::ns002::Type::actuateType;


our @ISA=qw(XML::Pastor::Builtin::token);

SAN::EAC::ns002::Type::actuateType->XmlSchemaType( bless( {
...
B<SAN::EAC::ns002::Type::actuateType>  -  A class generated by L<XML::Pastor> . 
