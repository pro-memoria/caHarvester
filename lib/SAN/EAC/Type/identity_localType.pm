...
package SAN::EAC::Type::identity_localType;


our @ISA=qw(XML::Pastor::Builtin::string);

SAN::EAC::Type::identity_localType->XmlSchemaType( bless( {
...
B<SAN::EAC::Type::identity_localType>  -  A class generated by L<XML::Pastor> . 
