...
package SAN::EAC::Type::date_standardDate_item_0003;


our @ISA=qw(XML::Pastor::Builtin::string);

SAN::EAC::Type::date_standardDate_item_0003->XmlSchemaType( bless( {
...
B<SAN::EAC::Type::date_standardDate_item_0003>  -  A class generated by L<XML::Pastor> . 
