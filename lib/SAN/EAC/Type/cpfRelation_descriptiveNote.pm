...
package SAN::EAC::Type::cpfRelation_descriptiveNote;


our @ISA=qw(XML::Pastor::Builtin::string);

SAN::EAC::Type::cpfRelation_descriptiveNote->XmlSchemaType( bless( {
...
B<SAN::EAC::Type::cpfRelation_descriptiveNote>  -  A class generated by L<XML::Pastor> . 
