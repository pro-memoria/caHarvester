...
package SAN::EAC::Type::nameEntry;

use SAN::EAC::Type::stringNotEmpty;

our @ISA=qw(XML::Pastor::ComplexType);

SAN::EAC::Type::nameEntry->mk_accessors( qw(_localType _langCode part));
...
SAN::EAC::Type::nameEntry->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'langCode' => bless( {
...
B<SAN::EAC::Type::nameEntry>  -  A class generated by L<XML::Pastor> . 
