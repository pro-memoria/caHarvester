...
package SAN::EAC::Type::maintenanceStatus;


our @ISA=qw(XML::Pastor::Builtin::token);

SAN::EAC::Type::maintenanceStatus->XmlSchemaType( bless( {
...
B<SAN::EAC::Type::maintenanceStatus>  -  A class generated by L<XML::Pastor> . 
