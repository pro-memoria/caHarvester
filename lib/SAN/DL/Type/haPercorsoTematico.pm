...
package SAN::DL::Type::haPercorsoTematico;

use SAN::DL::Type::rdfProperty;

our @ISA=qw(SAN::DL::Type::rdfProperty);

SAN::DL::Type::haPercorsoTematico->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
...
B<SAN::DL::Type::haPercorsoTematico>  -  A class generated by L<XML::Pastor> . 
