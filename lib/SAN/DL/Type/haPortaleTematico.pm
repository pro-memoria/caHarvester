...
package SAN::DL::Type::haPortaleTematico;

use SAN::DL::Type::rdfProperty;

our @ISA=qw(SAN::DL::Type::rdfProperty);

SAN::DL::Type::haPortaleTematico->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
...
B<SAN::DL::Type::haPortaleTematico>  -  A class generated by L<XML::Pastor> . 
