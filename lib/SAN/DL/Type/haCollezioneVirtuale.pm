...
package SAN::DL::Type::haCollezioneVirtuale;

use SAN::DL::Type::rdfProperty;

our @ISA=qw(SAN::DL::Type::rdfProperty);

SAN::DL::Type::haCollezioneVirtuale->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
...
B<SAN::DL::Type::haCollezioneVirtuale>  -  A class generated by L<XML::Pastor> . 
