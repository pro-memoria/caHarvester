...
package SAN::DL::Type::haRisorsaBibliografica;

use SAN::DL::Type::rdfProperty;

our @ISA=qw(SAN::DL::Type::rdfProperty);

SAN::DL::Type::haRisorsaBibliografica->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
...
B<SAN::DL::Type::haRisorsaBibliografica>  -  A class generated by L<XML::Pastor> . 
