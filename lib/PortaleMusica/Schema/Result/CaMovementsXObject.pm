use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXObject;
...
=head1 TABLE: C<ca_movements_x_objects>

=cut

__PACKAGE__->table("ca_movements_x_objects");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["movement_id", "object_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BxTEdceDZyFPQWkCYCBPVA
