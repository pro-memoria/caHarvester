use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationsXObjectRepresentation;
...
=head1 TABLE: C<ca_object_representations_x_object_representations>

=cut

__PACKAGE__->table("ca_object_representations_x_object_representations");
...
__PACKAGE__->add_columns(
  ...
  "source_info",
  { accessor => "column_source_info", data_type => "text", is_nullable => 0 },
  "sdatetime",
...
=item * L</representation_left_id>

=item * L</representation_right_id>
...
__PACKAGE__->belongs_to(
  ...
  { representation_id => "representation_left_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);

=head2 representation_right
...
__PACKAGE__->belongs_to(
  ...
  "CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentation",
  { representation_id => "representation_right_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:figVJG1+8gvOuPBKOwJRUg
