use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectsXObject;
...
=head1 TABLE: C<ca_objects_x_objects>

=cut

__PACKAGE__->table("ca_objects_x_objects");
...
=item * L</object_left_id>

=item * L</object_right_id>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:20AgllJ+cDNTtkiBIriVEg
