use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationsXOccurrence;
...
=head1 TABLE: C<ca_object_representations_x_occurrences>

=cut

__PACKAGE__->table("ca_object_representations_x_occurrences");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gDG3X+1E/rnHUNVPS+w7cA
