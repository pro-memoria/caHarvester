use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectsXOccurrence;
...
=head1 TABLE: C<ca_objects_x_occurrences>

=cut

__PACKAGE__->table("ca_objects_x_occurrences");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2AHm3lH5PsRAx8H6aMZ+MA
