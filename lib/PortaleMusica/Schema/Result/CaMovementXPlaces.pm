use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementXPlaces;
...
=head1 TABLE: C<ca_movements_x_places>

=cut

__PACKAGE__->table("ca_movements_x_places");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["movement_id", "place_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3d8Iqg0aEmJVv2+zGy/eeA
