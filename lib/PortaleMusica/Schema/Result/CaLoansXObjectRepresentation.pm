use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXObjectRepresentation;
...
=head1 TABLE: C<ca_loans_x_object_representations>

=cut

__PACKAGE__->table("ca_loans_x_object_representations");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tjeXyGwEdn+I0Z14OeyCmQ
