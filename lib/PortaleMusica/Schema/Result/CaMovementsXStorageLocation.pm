use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXStorageLocation;
...
=head1 TABLE: C<ca_movements_x_storage_locations>

=cut

__PACKAGE__->table("ca_movements_x_storage_locations");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cCg+EUb5yOtg9HNrW67UlQ
