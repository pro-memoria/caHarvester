use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectsXStorageLocation;
...
=head1 TABLE: C<ca_objects_x_storage_locations>

=cut

__PACKAGE__->table("ca_objects_x_storage_locations");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["object_id", "type_id", "sdatetime", "edatetime", "location_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KlBsYu+344aTkl7S36pBpw
