use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationsXStorageLocation;
...
=head1 TABLE: C<ca_object_representations_x_storage_locations>

=cut

__PACKAGE__->table("ca_object_representations_x_storage_locations");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pQ9/Zxor4FgGSCwfmk77Uw
