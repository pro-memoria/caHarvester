use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaEntitiesXVocabularyTerm;
...
=head1 TABLE: C<ca_entities_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_entities_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["entity_id", "type_id", "sdatetime", "edatetime", "item_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uyMY05YF8Y4H7UrXzGZBbw
