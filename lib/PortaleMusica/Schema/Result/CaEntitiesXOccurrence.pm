use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaEntitiesXOccurrence;
...
=head1 TABLE: C<ca_entities_x_occurrences>

=cut

__PACKAGE__->table("ca_entities_x_occurrences");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rtTfHQF9qlF+fK36TPYWTQ
