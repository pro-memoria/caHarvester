use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectsXVocabularyTerm;
...
=head1 TABLE: C<ca_objects_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_objects_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["object_id", "type_id", "sdatetime", "edatetime", "item_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:f9ALgZbGt70aXbKHM8s1Vg
