use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaTourStopsXObject;
...
=head1 TABLE: C<ca_tour_stops_x_objects>

=cut

__PACKAGE__->table("ca_tour_stops_x_objects");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["object_id", "stop_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SYqrFdGsxXUJpzpr/bIw0g
