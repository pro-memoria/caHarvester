use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaRepresentationAnnotationsXVocabularyTerm;
...
=head1 TABLE: C<ca_representation_annotations_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_representation_annotations_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["type_id", "annotation_id", "sdatetime", "edatetime", "item_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ticl+ES55+07wn9Pa0gEQw
