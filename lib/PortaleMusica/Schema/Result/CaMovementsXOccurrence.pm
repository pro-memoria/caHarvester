use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXOccurrence;
...
=head1 TABLE: C<ca_movements_x_occurrences>

=cut

__PACKAGE__->table("ca_movements_x_occurrences");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:fpRsFprqCI9AhSLaIlYiRw
