use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaCollectionsXCollection;
...
=head1 TABLE: C<ca_collections_x_collections>

=cut

__PACKAGE__->table("ca_collections_x_collections");
...
=item * L</collection_left_id>

=item * L</collection_right_id>
...
__PACKAGE__->belongs_to(
  ...
  { collection_id => "collection_left_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);

=head2 collection_right
...
__PACKAGE__->belongs_to(
  "collection_right",
  "CollectiveAccess::PortaleMusica::Schema::Result::CaCollection",
  { collection_id => "collection_right_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/7IaQjGRjkba7Tej/2Z5Cw
