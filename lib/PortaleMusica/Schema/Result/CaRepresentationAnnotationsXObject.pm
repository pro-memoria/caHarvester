use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaRepresentationAnnotationsXObject;
...
=head1 TABLE: C<ca_representation_annotations_x_objects>

=cut

__PACKAGE__->table("ca_representation_annotations_x_objects");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wSbM17OzZy1BNLmKRL/GVg
