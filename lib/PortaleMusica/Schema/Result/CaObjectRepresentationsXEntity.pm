use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationsXEntity;
...
=head1 TABLE: C<ca_object_representations_x_entities>

=cut

__PACKAGE__->table("ca_object_representations_x_entities");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:17L1jHS7DEPro/c6CTkzEA
