use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaCollectionsXStorageLocation;
...
=head1 TABLE: C<ca_collections_x_storage_locations>

=cut

__PACKAGE__->table("ca_collections_x_storage_locations");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xpCXPikEibD1PohNCvQl9g
