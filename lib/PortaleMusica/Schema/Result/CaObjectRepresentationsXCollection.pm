use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationsXCollection;
...
=head1 TABLE: C<ca_object_representations_x_collections>

=cut

__PACKAGE__->table("ca_object_representations_x_collections");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jl6piPFZeOJnTGhH7SXJ6Q
