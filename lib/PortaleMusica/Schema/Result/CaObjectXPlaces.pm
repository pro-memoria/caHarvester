use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectXPlaces;
...
=head1 TABLE: C<ca_objects_x_places>

=cut

__PACKAGE__->table("ca_objects_x_places");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["place_id", "object_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PLqaTFDPHzeBl/EL8IFiyQ
