use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXObjectRepresentation;
...
=head1 TABLE: C<ca_movements_x_object_representations>

=cut

__PACKAGE__->table("ca_movements_x_object_representations");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mU9Ejo7HGo2K0CVszPyD5Q
