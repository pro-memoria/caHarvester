use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaOccurrencesXStorageLocation;
...
=head1 TABLE: C<ca_occurrences_x_storage_locations>

=cut

__PACKAGE__->table("ca_occurrences_x_storage_locations");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KO0iZOMKro/dNZbAK/AFSg
