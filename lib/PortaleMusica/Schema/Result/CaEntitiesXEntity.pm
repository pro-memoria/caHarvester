use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaEntitiesXEntity;
...
=head1 TABLE: C<ca_entities_x_entities>

=cut

__PACKAGE__->table("ca_entities_x_entities");
...
=item * L</entity_left_id>

=item * L</entity_right_id>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:n2D4wEhiQw8tniwsILVlww
