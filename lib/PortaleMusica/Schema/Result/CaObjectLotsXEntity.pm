use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotsXEntity;
...
=head1 TABLE: C<ca_object_lots_x_entities>

=cut

__PACKAGE__->table("ca_object_lots_x_entities");
...
__PACKAGE__->add_unique_constraint("u_all", ["entity_id", "type_id", "sdatetime", "edatetime"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:E8OUQjR+5UgBVt6SrwLPkA
