use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXObjectLot;
...
=head1 TABLE: C<ca_movements_x_object_lots>

=cut

__PACKAGE__->table("ca_movements_x_object_lots");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["movement_id", "lot_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4LDFRXWBtf7AQyk7Radt+A
