use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXEntity;
...
=head1 TABLE: C<ca_movements_x_entities>

=cut

__PACKAGE__->table("ca_movements_x_entities");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["movement_id", "entity_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ELgYk+lWTUutj/sy5sbsvg
