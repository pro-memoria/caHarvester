use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotsXObjectLot;
...
=head1 TABLE: C<ca_object_lots_x_object_lots>

=cut

__PACKAGE__->table("ca_object_lots_x_object_lots");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ORQcxsEXDNx1NoyIMKpkTQ
