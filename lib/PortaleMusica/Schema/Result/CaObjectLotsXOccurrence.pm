use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotsXOccurrence;
...
=head1 TABLE: C<ca_object_lots_x_occurrences>

=cut

__PACKAGE__->table("ca_object_lots_x_occurrences");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["occurrence_id", "lot_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YSWkPJuCIDI19NWxN5+5nA
