use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaPlacesXVocabularyTerm;
...
=head1 TABLE: C<ca_places_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_places_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["place_id", "type_id", "sdatetime", "edatetime", "item_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vZitolMje4SNf5DKd5hd/A
