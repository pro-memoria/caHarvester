use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXVocabularyTerm;
...
=head1 TABLE: C<ca_loans_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_loans_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "item_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:69n0G7QwrYgtpKLN9291LA
