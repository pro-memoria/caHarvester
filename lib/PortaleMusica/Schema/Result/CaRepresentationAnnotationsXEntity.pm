use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaRepresentationAnnotationsXEntity;
...
=head1 TABLE: C<ca_representation_annotations_x_entities>

=cut

__PACKAGE__->table("ca_representation_annotations_x_entities");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CzNm7zFczZvWaVF2CE4kww
