use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaStorageLocationsXVocabularyTerm;
...
=head1 TABLE: C<ca_storage_locations_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_storage_locations_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["location_id", "item_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:35J8LZUzz2v+UWmnKrKFKA
