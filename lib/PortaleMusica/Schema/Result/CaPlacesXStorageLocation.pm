use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaPlacesXStorageLocation;
...
=head1 TABLE: C<ca_places_x_storage_locations>

=cut

__PACKAGE__->table("ca_places_x_storage_locations");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["place_id", "location_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AyLfP6/W7YhepmI6svmYdg
