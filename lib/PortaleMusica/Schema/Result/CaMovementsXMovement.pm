use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXMovement;
...
=head1 TABLE: C<ca_movements_x_movements>

=cut

__PACKAGE__->table("ca_movements_x_movements");
...
=item * L</movement_left_id>

=item * L</movement_right_id>
...
__PACKAGE__->belongs_to(
  ...
  { movement_id => "movement_left_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);

=head2 movement_right
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MgEaNMkYGQ34kWHI/xFdjA
