use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaStorageLocationsXStorageLocation;
...
=head1 TABLE: C<ca_storage_locations_x_storage_locations>

=cut

__PACKAGE__->table("ca_storage_locations_x_storage_locations");
...
=item * L</location_left_id>

=item * L</location_right_id>
...
__PACKAGE__->belongs_to(
  ...
  { location_id => "location_left_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);

=head2 location_right
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OhU/0DEAws0SP2zq2dlNFQ
