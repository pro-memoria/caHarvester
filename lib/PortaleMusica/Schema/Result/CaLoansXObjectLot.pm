use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXObjectLot;
...
=head1 TABLE: C<ca_loans_x_object_lots>

=cut

__PACKAGE__->table("ca_loans_x_object_lots");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "lot_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Uqb2Golv5qYNSM9rpVKEPg
