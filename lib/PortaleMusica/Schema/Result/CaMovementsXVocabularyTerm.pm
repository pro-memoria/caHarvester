use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXVocabularyTerm;
...
=head1 TABLE: C<ca_movements_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_movements_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["movement_id", "item_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tuhr7IDf18GxfK9BaWUifA
