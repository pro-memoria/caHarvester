use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaPlacesXOccurrence;
...
=head1 TABLE: C<ca_places_x_occurrences>

=cut

__PACKAGE__->table("ca_places_x_occurrences");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["place_id", "occurrence_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:E/uvwkY2RGgNihDL/QN73g
