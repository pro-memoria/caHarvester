use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaDataImporterLabel;
...
=head1 TABLE: C<ca_data_importer_labels>

=cut

__PACKAGE__->table("ca_data_importer_labels");
...
__PACKAGE__->add_unique_constraint("u_all", ["importer_id", "locale_id", "name", "is_preferred"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rkaPiAhEmtf9nxsQtJeUsA
