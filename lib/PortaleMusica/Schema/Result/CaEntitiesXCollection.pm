use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaEntitiesXCollection;
...
=head1 TABLE: C<ca_entities_x_collections>

=cut

__PACKAGE__->table("ca_entities_x_collections");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kgmAvy/vMwUmij8b5bCROA
