use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaEntityXPlaces;
...
=head1 TABLE: C<ca_entities_x_places>

=cut

__PACKAGE__->table("ca_entities_x_places");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["entity_id", "place_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:loeniEGSV8A0vJj6+p2zMg
