use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaPlacesXCollection;
...
=head1 TABLE: C<ca_places_x_collections>

=cut

__PACKAGE__->table("ca_places_x_collections");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["place_id", "collection_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bu4jmrIA95tG0UNsyHNhgg
