use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectsXObjectRepresentation;
...
=head1 TABLE: C<ca_objects_x_object_representations>

=cut

__PACKAGE__->table("ca_objects_x_object_representations");
...
__PACKAGE__->add_unique_constraint("u_all", ["object_id", "representation_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:R6V5Wj9u1C/winheYLs3Hg
