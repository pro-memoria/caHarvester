use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaTourStopsXTourStop;
...
=head1 TABLE: C<ca_tour_stops_x_tour_stops>

=cut

__PACKAGE__->table("ca_tour_stops_x_tour_stops");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rUspz8sQTso+zOsLYoTl+Q
