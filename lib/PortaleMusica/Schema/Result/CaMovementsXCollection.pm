use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaMovementsXCollection;
...
=head1 TABLE: C<ca_movements_x_collections>

=cut

__PACKAGE__->table("ca_movements_x_collections");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:INIvdUKZ91/j//jGHJXG3A
