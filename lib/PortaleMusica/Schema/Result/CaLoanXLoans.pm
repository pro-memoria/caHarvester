use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoanXLoans;
...
=head1 TABLE: C<ca_loans_x_loans>

=cut

__PACKAGE__->table("ca_loans_x_loans");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I2+hdmFxgLZCJ6R5IPFv6Q
