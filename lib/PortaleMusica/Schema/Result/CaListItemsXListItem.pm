use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaListItemsXListItem;
...
=head1 TABLE: C<ca_list_items_x_list_items>

=cut

__PACKAGE__->table("ca_list_items_x_list_items");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dEpL/lLplQsswG72oTjZJw
