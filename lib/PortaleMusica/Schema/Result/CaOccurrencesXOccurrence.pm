use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaOccurrencesXOccurrence;
...
=head1 TABLE: C<ca_occurrences_x_occurrences>

=cut

__PACKAGE__->table("ca_occurrences_x_occurrences");
...
=item * L</occurrence_left_id>

=item * L</occurrence_right_id>
...
__PACKAGE__->belongs_to(
  ...
  { occurrence_id => "occurrence_left_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);

=head2 occurrence_right
...
__PACKAGE__->belongs_to(
  "occurrence_right",
  "CollectiveAccess::PortaleMusica::Schema::Result::CaOccurrence",
  { occurrence_id => "occurrence_right_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IXr63mGw57i9SzWzZjWVoA
