use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectsXEntity;
...
=head1 TABLE: C<ca_objects_x_entities>

=cut

__PACKAGE__->table("ca_objects_x_entities");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["entity_id", "object_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:emv4TM7Z0tPB0gfdMFU+Xw
