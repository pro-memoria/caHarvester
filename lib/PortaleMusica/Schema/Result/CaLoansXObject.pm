use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXObject;
...
=head1 TABLE: C<ca_loans_x_objects>

=cut

__PACKAGE__->table("ca_loans_x_objects");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "object_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YKBDbG4CLrJzZpqTIp1BUg
