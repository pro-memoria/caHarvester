use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaTourStopsXVocabularyTerm;
...
=head1 TABLE: C<ca_tour_stops_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_tour_stops_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["item_id", "stop_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LEyOoHCztxSskQK/S9lYvQ
