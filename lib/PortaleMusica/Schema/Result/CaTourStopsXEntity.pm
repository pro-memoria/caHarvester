use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaTourStopsXEntity;
...
=head1 TABLE: C<ca_tour_stops_x_entities>

=cut

__PACKAGE__->table("ca_tour_stops_x_entities");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["entity_id", "stop_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bN19E5RA+hZtXcsc+mV4LA
