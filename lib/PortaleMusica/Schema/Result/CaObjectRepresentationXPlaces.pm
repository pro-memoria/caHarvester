use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationXPlaces;
...
=head1 TABLE: C<ca_object_representations_x_places>

=cut

__PACKAGE__->table("ca_object_representations_x_places");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xbR3BxCmC2d6PVw2X3rP6w
