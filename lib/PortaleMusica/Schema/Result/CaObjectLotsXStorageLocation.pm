use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotsXStorageLocation;
...
=head1 TABLE: C<ca_object_lots_x_storage_locations>

=cut

__PACKAGE__->table("ca_object_lots_x_storage_locations");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["lot_id", "type_id", "sdatetime", "edatetime", "location_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SXaPV3MWTx9lQ7PBcA4HzA
