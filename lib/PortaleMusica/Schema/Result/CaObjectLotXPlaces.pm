use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotXPlaces;
...
=head1 TABLE: C<ca_object_lots_x_places>

=cut

__PACKAGE__->table("ca_object_lots_x_places");
...
__PACKAGE__->add_unique_constraint("u_all", ["place_id", "type_id", "sdatetime", "edatetime"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:v6BNAlmWe3cFmvFxUgMbLA
