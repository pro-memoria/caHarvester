use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotsXCollection;
...
=head1 TABLE: C<ca_object_lots_x_collections>

=cut

__PACKAGE__->table("ca_object_lots_x_collections");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["lot_id", "collection_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:S2bH5rIZPrkU7LqxTGQnRA
