use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaPlaceXPlaces;
...
=head1 TABLE: C<ca_places_x_places>

=cut

__PACKAGE__->table("ca_places_x_places");
...
=item * L</place_left_id>

=item * L</place_right_id>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tjtKHIWHgg53OW/tup1d3Q
