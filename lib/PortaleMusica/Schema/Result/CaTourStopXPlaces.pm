use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaTourStopXPlaces;
...
=head1 TABLE: C<ca_tour_stops_x_places>

=cut

__PACKAGE__->table("ca_tour_stops_x_places");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["place_id", "stop_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:G1wM5QrvtKNhp3SqqmzyXA
