use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaRepresentationAnnotationsXOccurrence;
...
=head1 TABLE: C<ca_representation_annotations_x_occurrences>

=cut

__PACKAGE__->table("ca_representation_annotations_x_occurrences");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:owQie1VY9SUtqu8UbkCC1g
