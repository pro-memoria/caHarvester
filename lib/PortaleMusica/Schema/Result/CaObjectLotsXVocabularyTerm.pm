use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectLotsXVocabularyTerm;
...
=head1 TABLE: C<ca_object_lots_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_object_lots_x_vocabulary_terms");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["lot_id", "type_id", "sdatetime", "edatetime", "item_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EqUMTSVoYxVlBx0KdgCy5A
