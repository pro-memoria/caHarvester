use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaObjectRepresentationsXVocabularyTerm;
...
=head1 TABLE: C<ca_object_representations_x_vocabulary_terms>

=cut

__PACKAGE__->table("ca_object_representations_x_vocabulary_terms");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xeQZusHHoZ57G29zO6hrPg
