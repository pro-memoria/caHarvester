use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaOccurrencesXCollection;
...
=head1 TABLE: C<ca_occurrences_x_collections>

=cut

__PACKAGE__->table("ca_occurrences_x_collections");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WfmxoGMJrjevMip2a8HYtg
