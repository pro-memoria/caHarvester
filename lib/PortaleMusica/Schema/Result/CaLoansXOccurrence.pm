use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXOccurrence;
...
=head1 TABLE: C<ca_loans_x_occurrences>

=cut

__PACKAGE__->table("ca_loans_x_occurrences");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "occurrence_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IajBRH2eKVCpARsJX7zX2A
