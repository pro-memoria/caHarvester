use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXStorageLocation;
...
=head1 TABLE: C<ca_loans_x_storage_locations>

=cut

__PACKAGE__->table("ca_loans_x_storage_locations");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "location_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:v/8FwE2ZiGqAnPuagnGHVw
