use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoanXPlaces;
...
=head1 TABLE: C<ca_loans_x_places>

=cut

__PACKAGE__->table("ca_loans_x_places");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "place_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0wuDB5yOEtKjGR4faA6AEA
