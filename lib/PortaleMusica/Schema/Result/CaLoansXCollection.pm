use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaLoansXCollection;
...
=head1 TABLE: C<ca_loans_x_collections>

=cut

__PACKAGE__->table("ca_loans_x_collections");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["loan_id", "collection_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:j6wJW7QYCKqbfyvsDfh42w
