use utf8;
package CollectiveAccess::PortaleMusica::Schema::Result::CaTourStopsXCollection;
...
=head1 TABLE: C<ca_tour_stops_x_collections>

=cut

__PACKAGE__->table("ca_tour_stops_x_collections");
...
__PACKAGE__->add_unique_constraint(
  "u_all",
  ["collection_id", "stop_id", "type_id", "sdatetime", "edatetime"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ix6mUObUlrSGDrmdBqPPTg
